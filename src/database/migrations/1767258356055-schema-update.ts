...
export class SchemaUpdate1767258356055 implements MigrationInterface {
  name = 'SchemaUpdate1767258356055';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying, "lastName" character varying, "fullName" character varying, "avatar" character varying, "phoneNumber" character varying, "username" character varying, "email" character varying, "password" character varying, "authProvider" character varying, "isVerified" character varying NOT NULL DEFAULT false, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "isActive" boolean DEFAULT true, CONSTRAINT "UQ_1e3d0240b49c40521aaeb953293" UNIQUE ("phoneNumber"), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "file_storages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "storageType" character varying(50) NOT NULL, "fileType" character varying(100) NOT NULL, "folder" character varying(256) NOT NULL, "fileName" character varying(256) NOT NULL, "link" character varying(256), CONSTRAINT "PK_f33772005f420b3ad10dacc2079" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "permission_types" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "title" character varying NOT NULL, CONSTRAINT "PK_215b1e2fd4bb5499896fe8edaf4" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "title" character varying NOT NULL, "permissionTypeId" uuid NOT NULL, CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "role_permissions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "roleId" uuid NOT NULL, "permissionId" uuid NOT NULL, CONSTRAINT "PK_84059017c90bfcb701b8fa42297" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "auth_stats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isActive" boolean DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "createdById" uuid NOT NULL, "updatedById" uuid NOT NULL, "phoneNumber" character varying, "otp" integer, "otpExpiryAt" TIMESTAMP, CONSTRAINT "UQ_6b663b5cb7f3580dcff3acad56d" UNIQUE ("phoneNumber"), CONSTRAINT "PK_53274b28e95e8565b5b34990060" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
